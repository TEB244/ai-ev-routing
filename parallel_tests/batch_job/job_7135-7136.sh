#!/bin/bash
#SBATCH --job-name=Exp_parallel_train_7135_7136-GPUH100
#SBATCH --output=parallel_tests/batch_train_7135-7136/output.log
#SBATCH --error=parallel_tests/batch_train_7135-7136/error.log
